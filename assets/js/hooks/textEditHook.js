  ...
  mounted() {
    ...
    window.addEventListener(
      ...
      ({ detail: { id } }) => {
        ...
        // ALTERNATIVE SOLUTION IF I WAS NOT ABLE TO STOP LIVEVIEW IMPACTING QUILL'S CONTENT
        // console.log("edit quill:", quillForEditingModal);
        // console.log("editingQuiil text", existingJEs[id].getText());

        // quillElementInEditModal = document.querySelector(
        // "#modal_for_existing_journal_entry_to_edit .miroQuillWrapper"
        // );
        // quillElementInEditModal.replaceChildren();
        // quillElementInEditModal.textContent = "";
        // quillElementInEditModal.innerHTML = `<div class="miroQuillContainer"></div>`;
        // let quillForEditingModal = new Quill( // I may need to always create quill here as liveview is messing up the content of html generated by quill
        //   "#modal_for_existing_journal_entry_to_edit .miroQuillContainer",
        //   {
        //     modules: {
        //       toolbar: toolbarOptions,
