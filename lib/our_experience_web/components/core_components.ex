defmodule OurExperienceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OurExperienceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OurExperienceWeb.Gettext, "errors", msg, opts)
    end
  end
