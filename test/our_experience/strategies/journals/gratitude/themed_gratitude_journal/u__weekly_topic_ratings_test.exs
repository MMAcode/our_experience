defmodule OurExperience.Strategies.Journals.Gratitude.ThemedGratitudeJournal.U_WeeklyTopicRatings.U_WeeklyTopicRatingsTest do
  use OurExperience.DataCase

  alias OurExperience.Strategies.Journals.Gratitude.ThemedGratitudeJournal.U_WeeklyTopicRatings.U_WeeklyTopicRatings
  ...
  describe "u_weekly_topic_ratings" do
    ...
    test "get_u__weekly_topic_rating!/1 returns the u__weekly_topic_rating with given id" do
      ...
      assert U_WeeklyTopicRatings.get_u__weekly_topic_rating!(u__weekly_topic_rating.id) ==
    ...
    test "create_u__weekly_topic_rating/1 with valid data creates a u__weekly_topic_rating" do
      ...
      assert {:ok, %U_WeeklyTopicRating{} = u__weekly_topic_rating} =
               U_WeeklyTopicRatings.create_u__weekly_topic_rating(valid_attrs)
    ...
    test "create_u__weekly_topic_rating/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               U_WeeklyTopicRatings.create_u__weekly_topic_rating(@invalid_attrs)
    end
    ...
    test "update_u__weekly_topic_rating/2 with valid data updates the u__weekly_topic_rating" do
      ...
      assert {:ok, %U_WeeklyTopicRating{} = u__weekly_topic_rating} =
               U_WeeklyTopicRatings.update_u__weekly_topic_rating(
                 u__weekly_topic_rating,
                 update_attrs
               )
    ...
    test "update_u__weekly_topic_rating/2 with invalid data returns error changeset" do
      ...
      assert u__weekly_topic_rating ==
               U_WeeklyTopicRatings.get_u__weekly_topic_rating!(u__weekly_topic_rating.id)
    end

    test "delete_u__weekly_topic_rating/1 deletes the u__weekly_topic_rating" do
      u__weekly_topic_rating = u__weekly_topic_rating_fixture()

      assert {:ok, %U_WeeklyTopicRating{}} =
               U_WeeklyTopicRatings.delete_u__weekly_topic_rating(u__weekly_topic_rating)
    ...
    test "change_u__weekly_topic_rating/1 returns a u__weekly_topic_rating changeset" do
      ...
      assert %Ecto.Changeset{} =
               U_WeeklyTopicRatings.change_u__weekly_topic_rating(u__weekly_topic_rating)
    end
  end
end
